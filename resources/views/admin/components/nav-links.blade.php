...
<li class="sidebar-menu-item {{request()->segment(2) == 'course' ? 'open active' : ''}}">
    ...
    <ul class="sidebar-submenu collapse sm-indent"
        id="course_menu">
        <li class="sidebar-menu-item {{request()->segment(2) == 'course' ? 'active' : ''}}">
            <a class="sidebar-menu-button" href="{{route('admin.course.index')}}">
